  ...
  return (
    <nav className=' border-b-2 border-[#1C1F26] flex p-3 justify-between relative max-lg:hidden max-md:flex'>
        ...
        <div className='flex items-center w-full justify-end gap-2'>
          ...
          <button className=' hover:text-white max-md:hidden'> <CiBellOn className=' text-white w-10 p-2 rounded-md h-10 bg-[#1A1F26] aspect-square homepage_profile_card' /> </button>
          <div className='h-10 bg-[#1C1F26] p-1  flex gap-3 rounded-md profile_homepage_icon_right_upper_corner'>
            ...
            <div className='h-full aspect-square bg-orange-600 rounded-md flex items-center justify-center text-xl font-bold text-white Profile_Icon_Logo_Avatar  '>M</div>
