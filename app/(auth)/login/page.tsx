...
const LoginPage = () => {
    ...
    const form_handler = (element : any) => {
        element.preventDefault();
        console.log("submitting the form")
        localStorage.setItem("logined_user_email_of_daily_dev_copy_app", loginEmail)
        console.log(localStorage.getItem("logined_user_email_of_daily_dev_copy_app"))
        redirect('/')
    }
            ...
            <div className="content-container container px-5  z-10 mx-auto text-white my-20" >
                ...
                <div className="form-elements-container max-w-sm flex flex-col gap-5">
                    ...
                    <div className="form-container flex flex-col gap-3">
                        ...
                        <form action="" method="post" className='flex flex-col gap-2' onSubmit={form_handler}>
                        ...
                        <div className="email-input-container flex items-center gap-2 bg-white/10 rounded-md px-3 py-3 max-sm:py-1 hover:border-l-2 border-white ">
                            ...
                            <div className='flex flex-col w-full'>
                                <input type="email" name="EmailInputContainer" className='bg-transparent outline-none  ' id="" placeholder='Email' value={loginEmail}  onChange={(e:any)=>{setLoginEmail(e.target.value)
